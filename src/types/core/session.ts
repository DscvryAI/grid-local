...
/** Mirrors `src-tauri/src/models/provider.rs::ProviderTier`. `tier` is the
 * raw internal letter ("A"/"B") -- never render it directly, translate it
 * into user-facing wording (see `ProvidersMenuGroup`'s own coverage-label
 * mapping). */

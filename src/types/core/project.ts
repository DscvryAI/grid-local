...
export interface UserSettings {
  ...
  /** Whether the user has been shown the first-run "scan for other AI tools" prompt */
  hasSeenProviderDiscoveryPrompt?: boolean;
  /** Archive sync preference: "auto" (sync on every launch) or "manual" (only via Settings). Unset = not yet decided. */
  archiveSyncMode?: "auto" | "manual";
  /** Whether the user has been shown the one-time "keep your archive up to date?" prompt */
  hasSeenArchiveSyncPrompt?: boolean;
}

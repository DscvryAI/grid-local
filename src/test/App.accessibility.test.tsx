...
vi.mock("@/components/MessageViewer/MessageViewer", () => ({
...
vi.mock("@/components/SessionView/SessionView", () => ({
  // Real SessionView renders MessageNavigator (asideId="message-navigator")
  // on its default Conversation tab -- keep that landmark present here too,
  // since the accessibility smoke test below asserts on it directly.
  SessionView: () => (
    <div>
      session-view
      <aside id="message-navigator" tabIndex={-1}>
        message-navigator
      </aside>
    </div>
  ),

 ...
 * 생성 시간: 2026-08-31T04:34:17.286Z
 * 총 키 개수: 1947
 * Namespace 수: 10
 */
...
export type CommonKeys =
  ...
  | 'common.appName'
  | 'common.archiveSyncPrompt.auto'
  | 'common.archiveSyncPrompt.changeLater'
  | 'common.archiveSyncPrompt.description'
  | 'common.archiveSyncPrompt.manual'
  | 'common.archiveSyncPrompt.title'
  | 'common.back'
  | 'common.cancel'
  | 'common.clear'
  | 'common.close'
  ...
  | 'common.mobile.tab.history'
  | 'common.mobile.tab.insights'
  | 'common.mobile.tab.messages'
  | 'common.mobile.tab.projects'
  | 'common.mobile.tab.search'
  ...
  | 'common.saving'
  | 'common.selectFolder'
  | 'common.settings.about.licenses'
  | 'common.settings.about.reportIssue'
  | 'common.settings.about.title'
  ...
  | 'common.settings.archiveSync.auto'
  | 'common.settings.archiveSync.manual'
  | 'common.settings.archiveSync.syncError'
  | 'common.settings.archiveSync.syncNow'
  | 'common.settings.archiveSync.syncSuccess'
  | 'common.settings.archiveSync.syncing'
  | 'common.settings.archiveSync.title'
  | 'common.settings.changeFolder'
  | 'common.settings.checkUpdate'
  | 'common.settings.checking'
  | 'common.settings.data.deleteConfirmAction'
  | 'common.settings.data.deleteConfirmDescription'
  | 'common.settings.data.deleteConfirmTitle'
  | 'common.settings.data.deleteData'
  | 'common.settings.data.deleteError'
  | 'common.settings.data.deleteSuccess'
  | 'common.settings.data.diagnostics.description'
  | 'common.settings.data.diagnostics.exportAction'
  | 'common.settings.data.diagnostics.exportError'
  | 'common.settings.data.diagnostics.exportSuccess'
  | 'common.settings.data.diagnostics.loading'
  | 'common.settings.data.diagnostics.menuItem'
  | 'common.settings.data.diagnostics.title'
  | 'common.settings.data.openFolder'
  | 'common.settings.data.openFolderError'
  | 'common.settings.data.rebuildError'
  | 'common.settings.data.rebuildIndex'
  | 'common.settings.data.rebuildSuccess'
  | 'common.settings.data.rebuilding'
  | 'common.settings.data.resolvingPath'
  | 'common.settings.data.title'
  ...
  | 'common.settings.providers.detected'
  | 'common.settings.providers.empty'
  | 'common.settings.providers.rescan'
  | 'common.settings.providers.scanning'
  | 'common.settings.providers.title'
  ...
  | 'copyButton.copying'
  | 'copyButton.error'
  | 'history.bucket.earlierThisWeek'
  | 'history.bucket.older'
  | 'history.bucket.today'
  | 'history.bucket.yesterday'
  | 'history.customDirsOmitted'
  | 'history.empty'
  | 'history.filter.allModels'
  | 'history.filter.allProjects'
  | 'history.filter.allProviders'
  | 'history.filter.clearAll'
  ...
  | 'status.cancelIndexing'
  | 'status.checking'
  | 'status.indexingProgress'
  | 'status.indexingProvider'
  | 'status.initializing'
...
/**
 * analytics namespace의 번역 키 (232개)
...
export type AnalyticsKeys =
  ...
  | 'emptyState.building.progress'
  | 'emptyState.building.title'
  | 'emptyState.failed.description'
  | 'emptyState.failed.retry'
  | 'emptyState.failed.title'
  | 'emptyState.neverBuilt.description'
  | 'emptyState.neverBuilt.title'
  | 'emptyState.noData.title'
  | 'emptyState.unsupportedProvider.description'
  | 'emptyState.unsupportedProvider.title'
  | 'home.drillDown.empty'
  | 'home.drillDown.tokenCount'
  | 'home.recentWork.title'
  | 'home.recentWork.viewAll'
  | 'home.sinceLastVisit.agentRuns'
  | 'home.sinceLastVisit.projects'
  | 'home.sinceLastVisit.sessions'
  | 'home.sinceLastVisit.title'
  | 'home.sinceLastVisit.toolCalls'
  | 'home.thingsWorthLookingAt.title'
  | 'home.thisWeek.agentRuns'
  | 'home.thisWeek.peakAgents'
  | 'home.thisWeek.projects'
  | 'home.thisWeek.sessions'
  | 'home.thisWeek.title'
  | 'home.thisWeek.tokens'
  | 'insights.agents.empty'
  | 'insights.agents.failedCount'
  | 'insights.agents.subagentCount'
  | 'insights.agents.toggleTree'
  | 'insights.agents.toolCallCount'
  | 'insights.agents.totalCount'
  | 'insights.agents.treeEmpty'
  | 'insights.agents.unknownType'
  | 'insights.problems.empty'
  | 'insights.problems.errorCount'
  | 'insights.problems.failureCount'
  | 'insights.problems.repeatedCommandFailures'
  | 'insights.problems.repeatedErrors'
  | 'insights.tabs.agents'
  | 'insights.tabs.problems'
  | 'insights.tabs.tools'
  | 'insights.tabs.usage'
  | 'insights.tools.empty'
  | 'insights.tools.mostUsedSkills'
  | 'insights.tools.mostUsedSubagents'
  | 'insights.tools.mostUsedTools'
  | 'insights.tools.noData'
  | 'insights.tools.successRate';

/**
 * session namespace의 번역 키 (214개)
...
export type SessionKeys =
  ...
  | 'session.intelligence.files'
  | 'session.intelligence.tokens'
  | 'session.intelligence.toolCalls'
  ...
  | 'session.syncError'
  | 'session.tabs.agents'
  | 'session.tabs.agentsEmpty'
  | 'session.tabs.agentsFromArchive'
  | 'session.tabs.agentsSummary'
  | 'session.tabs.conversation'
  | 'session.tabs.estimatedCostInline'
  | 'session.tabs.files'
  | 'session.tabs.filesEmpty'
  | 'session.tabs.filesTouchCount'
  | 'session.tabs.overview'
  | 'session.tabs.tools'
  | 'session.tabs.toolsEmpty'
  | 'session.title'
  | 'session.untitled'
...
/**
 * renderers namespace의 번역 키 (401개)
...
export type RenderersKeys =
  ...
  | 'globalSearch.filter.allProviders'
  | 'globalSearch.filter.clearAll'
  | 'globalSearch.filter.dateRangeInvalid'
  | 'globalSearch.filter.endDate'
  | 'globalSearch.filter.startDate'
  | 'globalSearch.filterType.all'
  | 'globalSearch.filterType.assistant'
  | 'globalSearch.filterType.user'
  | 'globalSearch.hint'
  | 'globalSearch.matchLocation.assistant'
  | 'globalSearch.matchLocation.toolResult'
  | 'globalSearch.matchLocation.user'
  | 'globalSearch.matchedIn'
